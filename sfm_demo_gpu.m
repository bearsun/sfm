function sfm_demo_gpu
% push one more step on the stimuli, use gpu to speed up everything
% learned from the moglFDF / FDFDemo
...
InitializeMatlabOpenGL([], 3); % 3 for verbose, 0 for exp
Priority(1);
